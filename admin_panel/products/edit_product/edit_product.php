...
if (isset($_GET["product_id"])) {
    $_SESSION["product_id"] = $_GET["product_id"] / 50;
}
?>
<!DOCTYPE html>
<html lang="en">
...
<script>
    <?php include("C:/xampp/htdocs/php/medicine_website/admin_panel/products/edit_product/edit_product.js"); ?>
</script>
            ...
            <div class="content">
                ...
                foreach ($sel as $row) {
                    ...
                    <div class="card px-5 py-4 mb-5">
                        ...
                        <form action="http://localhost/php/medicine_website/admin_panel/products/update_data.php" class="category-form" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 border p-2 d-flex justify-content-center">
                                    <img class="category-img d-block w-50 m-auto" src="<?php echo (str_contains($row["cat_img"], "https")) ? $row["cat_img"] : "http://localhost/php/medicine_website/user_panel/shop/category_img/" . $row["cat_img"] . ""; ?>" />
                                </div>
                                ...
                                <div class="col-md-4 border p-3 pb-5">
                                    ...
                                    <input type="checkbox" class="mt-2 mb-4" /> Are you want to upload file?
                                    <input type="text" name="cat-img" class="form-control cat-img mt-3" placeholder="Enter HTTP URL here" value="<?php if (str_contains($row["cat_img"], "https")) echo $row["cat_img"]; ?>" />
                                </div>
                            </div>
                                    ...
                                    if ($r["item_img"] != null) {
                                        ...
                                        foreach (unserialize($r["item_img"]) as $img) { ?>
                                            <div class='row border-bottom py-4'>
                                                ...
                                                <div class='col-md-3 d-flex justify-content-center'><img src="<?php echo (str_contains($img, "https")) ? $img : "http://localhost/php/medicine_website/user_panel/shop/imgs/$img"; ?>" /></div>
                                                ...
                                                <div class='col-md-4'>
                                                    ...
                                                    <input type="text" name="item-img" class="form-control" placeholder="Enter HTTP URL here" disabled="true" required />
                    ...
                    <div class="card p-5 mt-5">
                        ...
                        <div class="row product-details">
                            ...
                            <div class="col-md-6">
                                <form action="http://localhost/php/medicine_website/admin_panel/products/update_data.php" method="post" enctype="multipart/form-data">
                                    <b style="color: red;">* Required Fields</b>
                                    <div class="row">
