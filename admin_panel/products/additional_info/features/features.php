...
<script>
    <?php include("C:/xampp/htdocs/php/medicine_website/admin_panel/products/additional_info/features/features.js"); ?>
</script>
            ...
            <div class="content">
                <div class="card p-5">
                    ...
                    foreach ($sel as $row) {
                        ...
                        <form class="features-form" action="http://localhost/php/medicine_website/admin_panel/products/additional_info/features/update.php" method="post" enctype="multipart/form-data">
                            <?php
                            $i = 0;
                            ...
                            ?>
                                    <div class="row">
                                        ...
                                        <?php if (isset($fea[0]) && isset($fea[1])) { ?>
                                            <div class="col-md-3 border p-3">
                                        ...
                                        <?php } ?>
                                        <div class="col-md-2 border p-3">
                                            <button class="btn btn-light" name="delete-features" value="<?php echo $i; ?>">Delete</button>
                                            <button class="btn btn-danger" name="update-features" value="<?php echo $i; ?>">Update</button>
                                        </div>
                                    </div>
                        <?php $i++;
                                }
                        ...
                        <button style="width: fit-content;" class="btn btn-light add-features mt-3" value="<?php echo $i; ?>">Add More Rows</button>
                </div>
            </div>
        </div>
