            ...
            <div class="content">
                <div class="card p-5">
                    ...
                    foreach ($sel as $row) {
                        ...
                        <h5 class="text-danger mt-5">Safety Information of the Product</h5>
                            ...
                            ?>
                                    <div class="row">
                                        ...
                                        <?php if (isset($saf[0]) && isset($saf[1])) { ?>
                                            ...
                                            <div class="col-md-6 border p-3">
                                                <textarea class="border w-100 text-secondary py-1 px-2" name="value[]" value="<?php echo $saf[1]; ?>" rows="5" required><?php echo $saf[1]; ?></textarea>
                                            </div>
                                        <?php } //
                                        else { ?>
                                            <div class="col-md-3 border p-3">
                                            ...
                                            <div class="col-md-6 border p-3">
                                                <textarea class="border w-100 text-secondary py-1 px-2" name="value[]" value="<?php echo $saf[1]; ?>" rows="5" required><?php echo $saf[0]; ?></textarea>
                                            </div>
                                        <?php } ?>
                                        <div class="col-md-2 border p-3">
