...
<head>
    ...
    <title>Edit Benefits</title>
    <?php include("C:/xampp/htdocs/php/medicine_website/admin_panel/links.php"); ?>
</head>

<script>
    <?php include("C:/xampp/htdocs/php/medicine_website/admin_panel/products/additional_info/benefits/benefits.js"); ?>
</script>
            ...
            <div class="content">
                <div class="card p-5">
                    ...
                    foreach ($sel as $row) {
                        ...
                        <h5 class="text-danger mt-5">Benefits of the Product</h5>
                        <div class="row p-0">
                        ...
                        <form class="benefits-form" action="http://localhost/php/medicine_website/admin_panel/products/additional_info/benefits/update.php" method="post" enctype="multipart/form-data">
                            <?php
                            ...
                            ?>
                                    <div class="row">
                                        ...
                                        <?php } ?>
                                        <div class="col-md-2 border p-3">
                                            <button class="btn btn-light" name="delete-benefits" value="<?php echo $i; ?>">Delete</button>
                                            <button class="btn btn-danger" name="update-benefits" value="<?php echo $i; ?>">Update</button>
                                        </div>
                                    </div>
                        <?php $i++;
                                }
                        ...
                        <button style="width: fit-content;" class="btn btn-light add-benefits mt-3" value="<?php echo $i; ?>">Add More Rows</button>
                </div>
            </div>
        </div>
