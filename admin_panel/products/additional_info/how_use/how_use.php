            ...
            <div class="content">
                <div class="card p-5">
                    ...
                    foreach ($sel as $row) {
                        ...
                        <h5 class="text-danger mt-5">how_use Details</h5>
                        <div class="row p-0">
                            ...
                            ?>
                                    <div class="row">
                                        ...
                                        <?php if (isset($how[0]) && isset($how[1])) { ?>
                                            ...
                                            <div class="col-md-6 border p-3">
                                                <textarea class="border w-100 text-secondary py-1 px-2" name="value[]" value="<?php echo $how[1]; ?>" rows="5"><?php echo $how[1]; ?></textarea>
                                            </div>
                                        <?php } //
                                        else { ?>
                                            <div class="col-md-3 border p-3">
                                            ...
                                            <div class="col-md-6 border p-3">
                                                <textarea class="border w-100 text-secondary py-1 px-2" name="value[]" value="<?php echo $how[1]; ?>" rows="5"><?php echo $how[0]; ?></textarea>
                                            </div>
                                        <?php } ?>
                                        <div class="col-md-2 border p-3">
