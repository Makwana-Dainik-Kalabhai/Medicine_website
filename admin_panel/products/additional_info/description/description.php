                            ...
                            ?>
                                    <div class="row">
                                        ...
                                        <?php if (isset($des[0]) && isset($des[1])) { ?>
                                            ...
                                            <div class="col-md-6 border p-3">
                                                <textarea class="border w-100 text-secondary py-1 px-2" name="value[]" value="<?php echo $des[1]; ?>" rows="5" required><?php echo $des[1]; ?></textarea>
                                            </div>
                                        <?php } //
                                        else { ?>
                                            <div class="col-md-3 border p-3">
                                            ...
                                            <div class="col-md-6 border p-3">
                                                <textarea class="border w-100 text-secondary py-1 px-2" name="value[]" value="<?php echo $des[1]; ?>" rows="5" required><?php echo $des[0]; ?></textarea>
                                            </div>
                                        <?php } ?>
                                        <div class="col-md-2 border p-3">
