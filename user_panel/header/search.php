...
if ($_POST["search_val"] != null) {
    ...
    foreach ($select as $row) { ?>
        <div><a href='http://localhost/php/medicine_website/user_panel/shop/product_details/product_details.php?item_code=<?php echo $row["item_code"]; ?>'><i class='fa-solid fa-magnifying-glass'></i>&emsp;<?php echo $row["name"]; ?></a></div>
<?php
    }
}
?>